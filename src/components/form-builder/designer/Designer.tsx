...
function Designer() {
    ...
    useDndMonitor({
        onDragEnd: (event: DragEndEvent) => {
            ...
            const isDragSidebarButton =
                active.data?.current?.isDesignerSidebarButton
            const isDragControl =
                active.data?.current?.isDesignerComponentWrapper

            const isDropOverDesignerArea =
                over.data?.current?.isDesignerDropArea
            const isDropOverTopHalf =
                over.data?.current?.isTopHalfDesignerComponent
